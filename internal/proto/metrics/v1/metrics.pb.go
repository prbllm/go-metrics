...
func (Metric_MType) Descriptor() protoreflect.EnumDescriptor {
	return file_api_proto_metrics_v1_metrics_proto_enumTypes[0].Descriptor()
}

func (Metric_MType) Type() protoreflect.EnumType {
	return &file_api_proto_metrics_v1_metrics_proto_enumTypes[0]
}
...
func (Metric_MType) EnumDescriptor() ([]byte, []int) {
	return file_api_proto_metrics_v1_metrics_proto_rawDescGZIP(), []int{0, 0}
}
...
func (x *UpdateMetricsResponse) Reset() {
	*x = UpdateMetricsResponse{}
	mi := &file_api_proto_metrics_v1_metrics_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*UpdateMetricsResponse) Descriptor() ([]byte, []int) {
	return file_api_proto_metrics_v1_metrics_proto_rawDescGZIP(), []int{2}
}
...
const file_api_proto_metrics_v1_metrics_proto_rawDesc = "" +
	"\n" +
	"\"api/proto/metrics/v1/metrics.proto\x12\ametrics\"\x90\x01\n" +
	"\x06Metric\x12\x0e\n" +
	...
	"\aMetrics\x12N\n" +
	"\rUpdateMetrics\x12\x1d.metrics.UpdateMetricsRequest\x1a\x1e.metrics.UpdateMetricsResponseBBZ@github.com/prbllm/go-metrics/internal/proto/metrics/v1;metricsv1b\x06proto3"
...
var file_api_proto_metrics_v1_metrics_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_api_proto_metrics_v1_metrics_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
...
func file_api_proto_metrics_v1_metrics_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		...
		EnumInfos:         file_api_proto_metrics_v1_metrics_proto_enumTypes,
